                    ...
                    >
                        <div className="user-list-div">
                            ...
                            <div className='d-flex gap-1'>
                                ...
                                <a class="icon-link" title={t("usersList.selectUserIcon")}
                                ...
                                <a class="icon-link" title={t("usersList.deleteUserIcon")}
                                ...
                                <a class="icon-link" title={t("usersList.updateUserIcon")}
                                ...
                                <a class="icon-link" title={displayUserDataText}
                                    onClick={handleDisplayUser} data-bs-toggle="modal"
                                    data-bs-target="#userInfoModal">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        width="16" height="16" fill="currentColor"
